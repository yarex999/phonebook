...
searchInput.addEventListener('input', function() {
    ...
    allCards.forEach(elem => elem.style.display = "none");


    for (let card of allCards) {
        let cardInner = card.firstChild;
        let cardInnerText = cardInner.lastChild.innerHTML
        console.log(cardInner.lastChild.innerHTML.toLowerCase());
        let searchInputInner = searchInput.value.toLowerCase();
        if (cardInnerText.startsWith(searchInputInner)) {
